...
<form id="submitForm" class="form-horizontal">
	<input name="id" value="${article.id}" type="text" hidden="hidden">
	<input type="text" name="uid" value="${loginUser.id}" hidden="hidden">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
    		<input class="form-control" type="text" id="cValue" name="color" value="#2b2b32" value="${article.color}"/>
        </div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" id="cover" name="cover" class="form-control" readOnly style="margin-bottom: 5px;" value="${article.cover}"/>
...
<script type="text/javascript">
	...
	//上传图片
	uploadImg("uploadCover", "cover", "upload/uploadImg.do", "${article.cover}");
	...
	submit = function(){
		...
		$.ajax({
            url: _urlPath + "admin/tech/updateArticle",
            dataType: "json",
            type: "post",
            data: data,
