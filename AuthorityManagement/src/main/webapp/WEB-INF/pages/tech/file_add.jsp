...
<form id="submitForm" class="form-horizontal" enctype="multipart/form-data" method="post">
	...
	<div class="form-group" style="display: none;">
		...
		<div class="col-sm-8">
			<input type="text" id="nowname" name="nowname" class="form-control" readOnly/>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" id="savepath" name="savepath" class="form-control" readOnly/>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-5">
			<input type="text" id="filesize" name="filesize" class="form-control" readOnly/>
		</div>
...
<script type="text/javascript">
	...
	submit = function(){
		...
		ajaxRequest("admin/tech/addFile", data);
	}
</script>